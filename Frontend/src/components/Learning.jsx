...
const FileList = () => {
    ...
    const fetchFiles = async () => {
        try {
            const response = await axios.get('https://forum-api-git-main-rayzen7s-projects.vercel.app/api/files/get');
    ...
    const handleDownload = async (fileId) => {
        try {
            const response = await axios.get(`https://forum-api-git-main-rayzen7s-projects.vercel.app/api/files/download/${fileId}`, {
                responseType: 'blob'
            });
